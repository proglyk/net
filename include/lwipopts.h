...
extern uint8_t lwip_heap_user[MEM_SIZE + 0x14];
...
// TODO кол-во должно как-то коррелировать с настройками программы
...
#define TCP_TMR_INTERVAL                50U

// выключаю краткие названия методов I/O
